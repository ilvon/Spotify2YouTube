                    ...
                    while True:
                        ...
                        for song in tracks:
                            ...
                            all_track_attrs.append({
                                ...
                                'Date_added': song['added_at'].replace('T', ' ').replace('Z', '')
                            })
